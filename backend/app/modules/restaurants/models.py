...
class Restaurant(Base):
    ...
    subdomain: Mapped[str | None] = mapped_column(String(120), unique=True, index=True, nullable=True)
    ...
    accent_color: Mapped[str] = mapped_column(String(20), default="#F59E0B", nullable=False)
    background_color: Mapped[str] = mapped_column(String(20), default="#FFFFFF", nullable=False)
    text_color: Mapped[str] = mapped_column(String(20), default="#0F172A", nullable=False)
    button_color: Mapped[str] = mapped_column(String(20), default="#078D50", nullable=False)
