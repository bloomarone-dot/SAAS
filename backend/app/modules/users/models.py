...
class User(Base):
    ...
    email: Mapped[str | None] = mapped_column(String(191), unique=True, index=True, nullable=True)
    ...
    # immediatement tous les jetons d'acces emis avec une version anterieure.
